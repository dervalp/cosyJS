var _ = require("underscore"),
    ...
    async = require("async"),
    gridBuilder = require("../structure/gridBuilder");
...
var buildControl = function (component) {
    ...
    var initialdata = _.extend(_.omit(component, ["data"]), component.data),
        control = this._c.exposedComponent(component, initialdata);
...
Page.prototype.render = function (cb) {
    ...
    buildControlsTree(serverSideComponents, self.placeholder, function (areas) {
        ...
        var pageTemplate = tmplSystem.compile(self.layout.template)({
            content: content,
            conf: stringiJSON,
